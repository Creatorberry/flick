      ...
      >
        <div style={{display: "flex", height: 94, borderBottom: "1px solid rgba(222,115,86,0.5)"}}>
          <div style={{width: 472, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 5, borderRight: "1px solid rgba(222,115,86,0.5)"}}>
            <div style={{fontSize: 13, color: "#fff0e8", fontWeight: 700}}>Welcome back Ikjot!</div>
            <Robot />
            <div style={{fontSize: 13, color: "#caa7b8"}}>qwen3.5:35b  •  API Usage Billing  •  Ikjot's</div>
            <div style={{fontSize: 13, color: "#d9c8d0"}}>Individual Org  ~/test_claude</div>
          </div>
